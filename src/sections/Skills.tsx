...
const Skills = ({hoveredSection}: { hoveredSection: HoveredSection }) => {
  ...
  return (
    <span className='skills' style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1fr', gridAutoFlow: 'column', gridTemplateRows: 'repeat(4, auto)', alignItems: 'center', justifyItems: 'center', rowGap: '25px', width: '100%', color: textColor }}>
      {/* Column 1 */}
